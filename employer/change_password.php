...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT password FROM employers WHERE id = $eid"));
    if (!$row || !password_verify($current, $row['password'])) {
        ...
        mysqli_query($conn, "UPDATE employers SET password = '" . mysqli_real_escape_string($conn, $hash) . "' WHERE id = $eid");
